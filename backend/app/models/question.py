...
class Question(Base):
    ...
    chapter_id = Column(Integer, ForeignKey("chapters.id"), nullable=False, comment="所属章节")
...
class ReviewSchedule(Base):
    ...
    scheduled_date = Column(DateTime, comment="计划复习日期")
    ...
    status = Column(String(20), default="pending", comment="状态: pending, completed, skipped")
