...
CREATE TABLE IF NOT EXISTS ai_search_settings (
    ...
    tavily_include_answer BOOLEAN NOT NULL DEFAULT 0,
    tavily_include_raw_content BOOLEAN NOT NULL DEFAULT 0,
...
ALTER TABLE ai_provider_settings ADD COLUMN max_context_tokens INTEGER;
